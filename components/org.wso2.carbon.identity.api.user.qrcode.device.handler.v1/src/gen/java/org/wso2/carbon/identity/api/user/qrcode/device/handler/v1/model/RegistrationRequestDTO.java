...
public class RegistrationRequestDTO  {
    ...
    **/
    ...
    @ApiModelProperty(example = "fuRr8s_eQrmB88nu5Tz8oa:APA91bFMqYbuzDYyOGK28VoiLHWYXZYzGNVg3tfxfNwKPH-" +
            ...
            value = "FCM token unique to the device")
    @JsonProperty("pushId")
    @Valid
    ...
    **/
    ...
    @ApiModelProperty(example =
            "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDOhCpj5pAEqdCdyxuHii0oLFAgnTePMI1EeomZHCRaZZNGv8fdcHyme9rpknNx/" +
                    "caAz9Gck5HrB/vto86cHpBkAghsBBLLWPUlblWNZCBX4pqFhZu+uZKvOnSqp1SwP13yx72nLKbjHRRJGgwCrg/mbdSGN/" +
                    "QKxRU+UhdKVVpQIDAQAB", value = "Public key of the keypair generated by the device for the account")
    ...
    /**
    * Signature string comprising the pushId and the challenge.
    **/
    ...
    @ApiModelProperty(example = "rT/VxgPYMioT6wHajYg0mJpBv46HvFBm/" +
            "elZ/VL4ClUIFfX7i3Ou5ER5sEiFtehaurLXPNsA8hF4SQAueVBRymEAmchhwYlT160g3wv6kDQvWLkTqnLWGfn++" +
            "wg5xRManOoN9zG9GhxCgRr9y+lk9rtvydfX0lTcdEZBkynSJnM=",
            value = "Signature string comprising of the pushId and the challenge")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(deviceId, model, name, publicKey, signature);
    }
