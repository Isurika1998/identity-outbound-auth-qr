...
public class DiscoveryDataDTO  {
    ...
    **/
    ...
    @ApiModelProperty(example = "carbon.super", value = "Tenant domain or Organisation")
    @JsonProperty("td")
    @Valid
    public String getTd() {
        return td;
    ...
    **/
    ...
    @ApiModelProperty(example = "/qr-auth/devices", value = "Registration endpoint")
    @JsonProperty("re")
    @Valid
    public String getRe() {
        return re;
    ...
    **/
    ...
    @ApiModelProperty(example = "qr-auth/authenticate", value = "Authentication endpoint")
    @JsonProperty("ae")
    @Valid
    public String getAe() {
        return ae;
    ...
    **/
    ...
    @ApiModelProperty(example = "qr-auth/devices/remove", value = "Remove device endpoint")
    @JsonProperty("rde")
    @Valid
