...
public class DeviceHandlerConstants {
    ...
    public static final String REGISTRATION_ENDPOINT = "/qr-auth/devices";
    public static final String REMOVE_DEVICE_ENDPOINT = "/qr-auth/devices/remove";
    public static final String AUTHENTICATION_ENDPOINT = "/qr-auth/authenticate";
