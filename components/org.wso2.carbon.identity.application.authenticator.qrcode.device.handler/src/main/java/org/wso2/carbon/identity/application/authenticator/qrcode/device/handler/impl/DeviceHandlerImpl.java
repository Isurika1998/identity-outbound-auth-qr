...
package org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.impl;

import org.wso2.carbon.context.CarbonContext;
import org.wso2.carbon.context.PrivilegedCarbonContext;
import org.wso2.carbon.identity.application.authentication.framework.exception.AuthenticationFailedException;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.DeviceHandler;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.DeviceHandlerConstants;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.cache.QRDeviceHandlerCacheKey;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.cache.RegistrationRequestChallengeCache;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.cache.RegistrationRequestChallengeCacheEntry;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.dao.DeviceDAO;
import org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.dao.DeviceDAOImpl;
...
public class DeviceHandlerImpl implements DeviceHandler {
    ...
    public Device registerDevice(RegistrationRequest registrationRequest)
        ...
        RegistrationRequestChallengeCacheEntry cacheEntry = RegistrationRequestChallengeCache.getInstance()
                .getValueFromCacheByRequestId(new QRDeviceHandlerCacheKey(registrationRequest.getDeviceId()));
        ...
        if (cacheEntry == null) {
            ...
            throw new QRDeviceHandlerClientException(errorMessage);
        }
    ...
    public void unregisterDevice(String deviceId)
        ...
        try {
            ...
            throw new QRDeviceHandlerServerException(errorMessage, e);
        }

    }

    @Override
    public void removeUserDevices(String userId) throws QRDeviceHandlerServerException {
    ...
    public void editDevice(String deviceId, String path, String value)
        ...
        try {
            ...
            throw new QRDeviceHandlerClientException(errorMessage, e);
        }
    }

    @Override
    public Device getDevice(String deviceId) throws QRDeviceHandlerServerException, QRDeviceHandlerClientException {
    ...
    @Override
    public List<Device> listDevices(String userId) throws QRDeviceHandlerServerException {
    ...
    @Override
    public RegistrationDiscoveryData getRegistrationDiscoveryData() throws QRDeviceHandlerServerException {
     ...
     * @throws QRDeviceHandlerServerException - if an error occurs while getting user claims
     */
    private RegistrationDiscoveryData prepareDiscoveryData(User user) throws QRDeviceHandlerServerException {
     ...
     * @throws QRDeviceHandlerClientException - if the signature is not valid
     * @throws QRDeviceHandlerServerException - if a server error occurs while validating the signature
     */
    private void handleSignatureVerification(
            ...
            throws QRDeviceHandlerClientException, QRDeviceHandlerServerException {
     ...
     * @throws QRDeviceHandlerServerException - if a server error occurs
     */
     ...
     * @throws QRDeviceHandlerServerException - if an error occurs while storing data in the database
     */
        ...
        try {
            switch (path) {
                ...
                case "/push-id":
                    ...
                    break;
                default:
                    throw new QRDeviceHandlerClientException("Invalid path for updating device: "
                            + device.getDeviceId() + ".");
            }
    ...
    private void addToCache(User user, RegistrationDiscoveryData discoveryData) {
        ...
        RegistrationRequestChallengeCache.getInstance().addToCacheByRequestId(
                new QRDeviceHandlerCacheKey(discoveryData.getDeviceId()),
    ...
    private void clearCache(String deviceID) {
        ...
        RegistrationRequestChallengeCache.getInstance().clearCacheEntryByRequestId(
                new QRDeviceHandlerCacheKey(deviceID));
    }
