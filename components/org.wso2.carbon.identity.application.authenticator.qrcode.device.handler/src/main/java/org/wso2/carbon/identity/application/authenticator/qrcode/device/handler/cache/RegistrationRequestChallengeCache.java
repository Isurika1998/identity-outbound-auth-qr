...
package org.wso2.carbon.identity.application.authenticator.qrcode.device.handler.cache;
import org.wso2.carbon.identity.application.authentication.framework.store.SessionDataStore;
import org.wso2.carbon.identity.application.common.cache.BaseCache;
import org.wso2.carbon.utils.CarbonUtils;

/**
 * QR Device handler cache to store interim data.
 */
public class RegistrationRequestChallengeCache extends
        BaseCache<QRDeviceHandlerCacheKey, RegistrationRequestChallengeCacheEntry> {
    ...
    public void clearCacheEntryByRequestId(QRDeviceHandlerCacheKey key) {

        super.clearCacheEntry(key);
        clearFromSessionStore(key.getRequestId());
    }

    public void addToCacheByRequestId(QRDeviceHandlerCacheKey key,
    ...
    public RegistrationRequestChallengeCacheEntry getValueFromCacheByRequestId(QRDeviceHandlerCacheKey key) {
