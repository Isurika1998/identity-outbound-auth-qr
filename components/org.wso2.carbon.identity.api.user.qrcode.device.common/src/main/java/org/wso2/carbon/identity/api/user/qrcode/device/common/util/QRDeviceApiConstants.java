...
/**
 * Constants used in QR Device handler Rest APIs.
 */
public class QRDeviceApiConstants {
    ...
    public static final String QR_AUTH_DEVICE_PATH = "/qr-auth/devices";
    public static final String QR_AUTH_GET_DEVICE_PATH = QR_AUTH_DEVICE_PATH + "/%s";
